...
Implements bounded buffer with producer-consumer threads
Ensures:
No data loss
No deadlocks
...
Supports execution of CPU-bound and I/O-bound workloads
...
Logging	Bounded buffer	Added complexity for synchronization
